...
| 2 | Not started | Occupied-city selection fix | Ensure cities remain selectable/manageable when a unit occupies the same tile. | `codex-prompts/02_fix_occupied_city_selection.md`, `decisions/ADR-0002-occupied-city-selection.md` |
