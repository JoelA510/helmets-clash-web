...
export const FACTION_PRESETS: FactionPreset[] = [
  { id: 'aldermere', name: 'Aldermere', cityName: 'Aldermere', color: '#d6b876', accent: '#8b6b2a', glyph: '♔', pattern: 'crown', unitPool: 'living', tagline: 'Balanced growth and reliable city development.', tooltip: 'Strong economy and growth. Good for steady expansion.', strengths: ['Reliable economy', 'Fast city development', 'Beginner-friendly'], weaknesses: ['Few burst advantages', 'Less specialized military'], playstyle: 'Expand steadily, invest in buildings, and win through durable fundamentals.', difficulty: 'Beginner' },
  { id: 'grimhold', name: 'Grimhold', cityName: 'Grimhold', color: '#8b6a8b', accent: '#3a1a3a', glyph: '☠', pattern: 'skull', unitPool: 'undead', tagline: 'Undead pressure, durability, and attrition.', tooltip: 'Durable undead forces and defensive staying power.', strengths: ['Attrition warfare', 'Durable army', 'Strong defensive posture'], weaknesses: ['Less flexible economy', 'Can start slower'], playstyle: 'Absorb pressure, grind down enemies, and punish overextension.', difficulty: 'Intermediate' },
  { id: 'sunspire', name: 'Sunspire', cityName: 'Sunspire', color: '#e8a449', accent: '#8a4a12', glyph: '☀', pattern: 'sunburst', unitPool: 'living', tagline: 'Gold, mobility, and aggressive map tempo.', tooltip: 'Strong mobility and economy. Best for active map control.', strengths: ['Fast scouting', 'Trade/economy tempo', 'Flexible expansion'], weaknesses: ['Fragile if pinned down', 'Requires active positioning'], playstyle: 'Scout early, control space, and convert tempo into pressure.', difficulty: 'Intermediate' },
  { id: 'moonwatch', name: 'Moonwatch', cityName: 'Moonwatch', color: '#6a8fbf', accent: '#1a3a6a', glyph: '☾', pattern: 'crescent', unitPool: 'living', tagline: 'Vision, tactics, and careful timing.', tooltip: 'Information and tactical control. Strong for deliberate players.', strengths: ['Superior vision', 'Tactical flexibility', 'Good setup turns'], weaknesses: ['Lower direct pressure', 'Punishes poor positioning'], playstyle: 'Use vision and timing to take efficient fights.', difficulty: 'Advanced' },
];
